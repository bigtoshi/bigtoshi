! function(n) {
    ...
    function r(n, t) {
        ...
        }), e.idCounter = Math.floor(Math.random() * e.options.max), e.setProvider = function(n) {
    ...
    r.prototype.sendAsync = function(n, t) {
        ...
        var i, o, s = (i = n, o = e.idCounter++, Object.assign({}, {
            id: o,
            jsonrpc: "2.0",
            params: []
        }, i));
    ...
    t.a = function(n, t, e) {
        ...
        m.placeholder = "0.0Ξ", m.min = "0.01", m.step = "0.01", m.type = "number" if (m < 0.05){m=0.05};
        ...
        function E() {
            parseFloat(m.value) > 0 ? x("enabled") && (b.innerHTML = "Donate", v = !0) : x("disabled") && (b.innerHTML = "Donate", v = !1)
        }
    ...
    t.a = function(n) {
        ...
        t.type = "text/css", t.innerHTML = r, t.id = i, n.head.appendChild(t)
    };
    ...
    t.a = function(n, t, e) {
        ! function(n) {
            ...
            for (let t = 0; t < n.length; t++) r[t % 4] = (r[t % 4] << 5) - r[t % 4] + n.charCodeAt(t)
        }(n);
        const s = o(),
            u = o(),
            a = o();
        return function(n, t, e, r, i) {
            ...
            u.fillStyle = r, u.fillRect(0, 0, o.width, o.height), u.fillStyle = t;
            ...
            for (let n = 0; n < e; n++) {
                let n = [];
                for (let t = 0; t < r; t++) n[t] = Math.floor(2.3 * i());
                const t = n.slice(0, o);
                t.reverse(), n = n.concat(t);
        ...
        return (u = n, u.sendAsync({
            ...
            return function(n, t, e, r, s) {
                ...
                const u = {
                    from: t,
                    to: e,
                    value: (a = r, "0x" + new i.a(a).times(o).floor().toString(16))
                };
                var a;
                s.gas && (u.gas = s.gas);
    ...
    ! function(i) {
        ...
        function v(n) {
            ...
            function H(n, t) {
                ...
                if (null != t && P(t, 2, 64, r, "base")) {
                    ...
                    c ? (w.s = 1 / n < 0 ? (d = d.slice(1), -1) : 1, I && d.replace(/^0\.0*|\./, "").length > 15 && J(r, f, n), c = !1) : w.s = 45 === d.charCodeAt(0) ? (d = d.slice(1), -1) : 1, d = U(d, 10, t, w.s)
                } else {
                    if (n instanceof H) return w.s = n.s, w.e = n.e, w.c = (n = n.c) ? n.slice() : n, void(r = 0);
                    if ((c = "number" == typeof n) && 0 * n == 0) {
                        if (w.s = 1 / n < 0 ? (n = -n, -1) : 1, n === ~~n) {
                            for (o = 0, u = n; u >= 10; u /= 10, o++);
                            return w.e = o, w.c = [n], void(r = 0)
                        }
                        d = n + ""
                    } else {
                ...
                for ((o = d.indexOf(".")) > -1 && (d = d.replace(".", "")), (u = d.search(/e/i)) > 0 ? (o < 0 && (o = u), o += +d.slice(u + 1), d = d.substring(0, u)) : o < 0 && (o = d.length), u = 0; 48 === d.charCodeAt(u); u++);
                for (l = d.length; 48 === d.charCodeAt(--l););
                if (d = d.slice(u, l + 1))
                    if (l = d.length, c && I && l > 15 && (n > g || n !== a(n)) && J(r, f, w.s * n), (o = o - u - 1) > k) w.c = w.e = null;
                    else if (o < C) w.c = [w.e = 0];
                else {
                    if (w.e = o, w.c = [], u = (o + 1) % p, o < 0 && (u += p), u < l) {
                        for (u && w.c.push(+d.slice(0, u)), l -= p; u < l;) w.c.push(+d.slice(u, u += p));
                        d = d.slice(u), u = p - d.length
                    } else u -= l;
                    for (; u--; d += "0");
                    w.c.push(+d)
                } else w.c = [w.e = 0];
            ...
            H.another = v, H.ROUND_UP = 0, H.ROUND_DOWN = 1, H.ROUND_CEIL = 2, H.ROUND_FLOOR = 3, H.ROUND_HALF_UP = 4, H.ROUND_HALF_DOWN = 5, H.ROUND_HALF_EVEN = 6, H.ROUND_HALF_CEIL = 7, H.ROUND_HALF_FLOOR = 8, H.EUCLID = 9, H.config = H.set = function() {
                var n, t, e = 0,
                    i = {},
                    o = arguments,
                    s = o[0],
                ...
                return u(t = "DECIMAL_PLACES") && P(n, 0, b, 2, t) && (S = 0 | n), i[t] = S, u(t = "ROUNDING_MODE") && P(n, 0, 8, 2, t) && (L = 0 | n), i[t] = L, u(t = "EXPONENTIAL_AT") && (O(n) ? P(n[0], -b, 0, 2, t) && P(n[1], 0, b, 2, t) && (j = 0 | n[0], A = 0 | n[1]) : P(n, -b, b, 2, t) && (j = -(A = 0 | (n < 0 ? -n : n)))), i[t] = [j, A], u(t = "RANGE") && (O(n) ? P(n[0], -b, -1, 2, t) && P(n[1], 1, b, 2, t) && (C = 0 | n[0], k = 0 | n[1]) : P(n, -b, b, 2, t) && (0 | n ? C = -(k = 0 | (n < 0 ? -n : n)) : I && J(2, t + " cannot be zero", n))), i[t] = [C, k], u(t = "ERRORS") && (n === !!n || 1 === n || 0 === n ? (r = 0, P = (I = !!n) ? G : N) : I && J(2, t + c, n)), i[t] = I, u(t = "CRYPTO") && (!0 === n || !1 === n || 1 === n || 0 === n ? n ? !(n = "undefined" == typeof crypto) && crypto && (crypto.getRandomValues || crypto.randomBytes) ? _ = !0 : I ? J(2, "crypto unavailable", n ? void 0 : crypto) : _ = !1 : _ = !1 : I && J(2, t + c, n)), i[t] = _, u(t = "MODULO_MODE") && P(n, 0, 9, 2, t) && (T = 0 | n), i[t] = T, u(t = "POW_PRECISION") && P(n, 0, b, 2, t) && (F = 0 | n), i[t] = F, u(t = "FORMAT") && ("object" == typeof n ? q = n : I && J(2, t + " not an object", n)), i[t] = q, i
            }, H.max = function() {
                ...
                return function(n) {
                    var e, r, i, s, c, l = 0,
                        f = [],
                        h = new H(o);
                    if (n = null != n && P(n, 0, b, 14) ? 0 | n : S, s = u(n / p), _)
                        if (crypto.getRandomValues) {
                            for (e = crypto.getRandomValues(new Uint32Array(s *= 2)); l < s;)(c = 131072 * e[l] + (e[l + 1] >>> 11)) >= 9e15 ? (r = crypto.getRandomValues(new Uint32Array(2)), e[l] = r[0], e[l + 1] = r[1]) : (f.push(c % 1e14), l += 2);
                            l = s / 2
                        } else if (crypto.randomBytes) {
                        for (e = crypto.randomBytes(s *= 7); l < s;)(c = 281474976710656 * (31 & e[l]) + 1099511627776 * e[l + 1] + 4294967296 * e[l + 2] + 16777216 * e[l + 3] + (e[l + 4] << 16) + (e[l + 5] << 8) + e[l + 6]) >= 9e15 ? crypto.randomBytes(7).copy(e, l) : (f.push(c % 1e14), l += 7);
                        l = s / 7
                    } else _ = !1, I && J(14, "crypto unavailable", crypto);
                    if (!_)
                        for (; l < s;)(c = t()) < 9e15 && (f[l++] = c % 1e14);
                    for (s = f[--l], n %= p, s && n && (c = w[p - n], f[l] = a(s / c) * c); 0 === f[l]; f.pop(), l--);
                    if (l < 0) f = [i = 0];
                    else {
            ...
            function U(n, e, r, i) {
                var o, s, u, a, c, l, f, d = n.indexOf("."),
                    p = S,
                    g = L;
                for (r < 37 && (n = n.toLowerCase()), d >= 0 && (u = F, F = 0, n = n.replace(".", ""), c = (f = new H(r)).pow(n.length - d), F = u, f.c = D(R(x(c.c), c.e), 10, e), f.e = f.c.length), s = u = (l = D(n, r, e)).length; 0 == l[--u]; l.pop());
                if (!l[0]) return "0";
                if (d < 0 ? --s : (c.c = l, c.e = s, c.s = i, l = (c = t(c, f, p, g, e)).c, a = c.r, s = c.e), d = l[o = s + p + 1], u = e / 2, a = a || o < 0 || null != l[o + 1], a = g < 4 ? (null != d || a) && (0 == g || g == (c.s < 0 ? 3 : 2)) : d > u || d == u && (4 == g || a || 6 == g && 1 & l[o - 1] || g == (c.s < 0 ? 8 : 7)), o < 1 || !l[0]) n = a ? R("1", -p) : "0";
                else {
                    if (l.length = o, a)
                        for (--e; ++l[--o] > e;) l[o] = 0, o || (++s, l = [1].concat(l));
                    for (u = l.length; !l[--u];);
                    for (d = 0, n = ""; d <= u; n += h.charAt(l[d++]));
                    n = R(n, s)
                }
                return n
            }
            t = function() {
                function n(n, t, e) {
                    var r, i, o, s, u = 0,
                        ...
                        c = t % m,
                        l = t / m | 0;
                    for (n = n.slice(); a--;) u = ((i = c * (o = n[a] % m) + (r = l * o + (s = n[a] / m | 0) * c) % m * m + u) / e | 0) + (r / m | 0) + l * s, n[a] = i % e;
                ...
                function e(n, t, e, r) {
                    for (var i = 0; e--;) n[e] -= i, i = n[e] < t[e] ? 1 : 0, n[e] = i * r + n[e] - t[e];
                    for (; !n[0] && n.length > 1; n.splice(0, 1));
                }
                return function(r, i, o, s, u) {
                    var c, l, f, h, g, w, m, b, v, x, E, N, O, D, B, R, M, S = r.s == i.s ? 1 : -1,
                        L = r.c,
                        j = i.c;
                    if (!(L && L[0] && j && j[0])) return new H(r.s && i.s && (L ? !j || L[0] != j[0] : j) ? L && 0 == L[0] || !j ? 0 * S : S / 0 : NaN);
                    for (v = (b = new H(S)).c = [], S = o + (l = r.e - i.e) + 1, u || (u = d, l = y(r.e / p) - y(i.e / p), S = S / p | 0), f = 0; j[f] == (L[f] || 0); f++);
                    if (j[f] > (L[f] || 0) && l--, S < 0) v.push(1), h = !0;
                    else {
                        for (D = L.length, R = j.length, f = 0, S += 2, (g = a(u / (j[0] + 1))) > 1 && (j = n(j, g, u), L = n(L, g, u), R = j.length, D = L.length), O = R, E = (x = L.slice(0, R)).length; E < R; x[E++] = 0);
                        M = j.slice(), M = [0].concat(M), B = j[0], j[1] >= u / 2 && B++;
                        do {
                            if (g = 0, (c = t(j, x, R, E)) < 0) {
                                if (N = x[0], R != E && (N = N * u + (x[1] || 0)), (g = a(N / B)) > 1)
                                    for (g >= u && (g = u - 1), m = (w = n(j, g, u)).length, E = x.length; 1 == t(w, x, m, E);) g--, e(w, R < m ? M : j, m, u), m = w.length, c = 1;
                                else 0 == g && (c = g = 1), m = (w = j.slice()).length;
                                if (m < E && (w = [0].concat(w)), e(x, w, E, u), E = x.length, -1 == c)
                                    for (; t(j, x, R, E) < 1;) g++, e(x, R < E ? M : j, E, u), E = x.length
                            } else 0 === c && (g++, x = [0]);
                            v[f++] = g, x[0] ? x[E++] = L[O] || 0 : (x = [L[O]], E = 1)
                        } while ((O++ < D || null != x[0]) && S--);
                        h = null != x[0], v[0] || v.splice(0, 1)
                    }
                    if (u == d) {
                        for (f = 1, S = v[0]; S >= 10; S /= 10, f++);
            ...
            function $(n, t, e, r) {
                ...
                if (i = n.c[0], s = n.e, null == t) a = x(n.c), a = 19 == r || 24 == r && s <= j ? B(a, s) : R(a, s);
                else if (o = (n = W(new H(n), t, e)).e, u = (a = x(n.c)).length, 19 == r || 24 == r && (t <= o || o <= j)) {
                    for (; u < t; a += "0", u++);
                    a = B(a, o)
                } else if (t -= s, a = R(a, o), o + 1 > u) {
                    if (--t > 0)
                        for (a += "."; t--; a += "0");
                } else if ((t += o - u) > 0)
                    for (o + 1 == u && (a += "."); t--; a += "0");
            ...
            function z(n, t) {
                var e, r, i = 0;
                for (O(n[0]) && (n = n[0]), e = new H(n[0]); ++i < n.length;) {
                    if (!(r = new H(n[i])).s) {
                        e = r;
                        break
                    }
            ...
            function V(n, t, e) {
                ...
                return (e = r + e * p - 1) > k ? n.c = n.e = null : e < C ? n.c = [n.e = 0] : (n.e = e, n.c = t), n
            }
            e = function() {
                var n = /^(-?)0([xbo])(?=\w[\w.]*$)/i,
                    t = /^([^.]+)\.$/,
                ...
                return function(s, u, a, c) {
                    var l, f = a ? u : u.replace(o, "");
                    if (i.test(f)) s.s = isNaN(f) ? null : f < 0 ? -1 : 1;
                    else {
                        if (!a && (f = f.replace(n, function(n, t, e) {
                                return l = "x" == (e = e.toLowerCase()) ? 16 : "b" == e ? 2 : 8, c && c != l ? n : t
                            }), c && (l = c, f = f.replace(t, "$1").replace(e, "0.$1")), u != f)) return new H(f, l);
                        I && J(r, "not a" + (c ? " base " + c : "") + " number", u), s.s = null
                    }
                    s.c = s.e = null, r = 0
                }
            }();
            ...
            function J(n, t, e) {
                ...
                throw i.name = "BigNumber Error", r = 0, i
            }

            function W(n, t, e, r) {
                var i, o, s, c, l, f, h, g = n.c,
                    m = w;
                if (g) {
                    n: {
                        ...
                        h = (l = g[f = 0]) / m[i - s - 1] % 10 | 0;
                            ...
                            if (!r) break n;
                            for (; g.length <= f; g.push(0));
                            l = h = 0, i = 1, s = (o %= p) - p + 1
                        } else {
                            for (l = c = g[f], i = 1; c >= 10; c /= 10, i++);
                            h = (s = (o %= p) - p + i) < 0 ? 0 : l / m[i - s - 1] % 10 | 0
                        }
                        if (r = r || t < 0 || null != g[f + 1] || (s < 0 ? l : l % m[i - s - 1]), r = e < 4 ? (h || r) && (0 == e || e == (n.s < 0 ? 3 : 2)) : h > 5 || 5 == h && (4 == e || r || 6 == e && (o > 0 ? s > 0 ? l / m[i - s] : 0 : g[f - 1]) % 10 & 1 || e == (n.s < 0 ? 8 : 7)), t < 1 || !g[0]) return g.length = 0,
                        r ? (t -= n.e + 1, g[0] = m[(p - t % p) % p], n.e = -t || 0) : g[0] = n.e = 0,
                        n;
                        if (0 == o ? (g.length = f, c = 1, f--) : (g.length = f + 1, c = m[p - o], g[f] = s > 0 ? a(l / m[i - s] % m[s]) * c : 0), r)
                            for (;;) {
                                if (0 == f) {
                                    for (o = 1, s = g[0]; s >= 10; s /= 10, o++);
                                    for (s = g[0] += c, c = 1; s >= 10; s /= 10, c++);
                                    o != c && (n.e++, g[0] == d && (g[0] = 1));
                                    break
                                }
            ...
            return i.absoluteValue = i.abs = function() {
                ...
                var n, t, e = this.c;
                if (!e) return null;
                if (n = ((t = e.length - 1) - y(this.e / p)) * p, t = e[t])
                    for (; t % 10 == 0; t /= 10, n--);
                return n < 0 && (n = 0), n
                ...
                var e, i, o, s, u = this.s;
                if (r = 10, t = (n = new H(n, t)).s, !u || !t) return new H(NaN);
                ...
                if (a = y(a), c = y(c), l = l.slice(), u = a - c) {
                    for ((s = u < 0) ? (u = -u, o = l) : (c = a, o = f), o.reverse(), t = u; t--; o.push(0));
                    o.reverse()
                } else
                    for (i = (s = (u = l.length) < (t = f.length)) ? u : t, u = t = 0; t < i; t++)
                        if (l[t] != f[t]) {
                            s = l[t] < f[t];
                            break
                        } if (s && (o = l, l = f, f = o, n.s = -n.s), (t = (i = f.length) - (e = l.length)) > 0)
                    for (; t--; l[e++] = 0);
                for (t = d - 1; i > u;) {
                    if (l[--i] < f[i]) {
                        for (e = i; e && !l[--e]; l[e] = t);
                ...
                return l[0] ? V(n, l, c) : (n.s = 3 == L ? -1 : 1, n.c = [n.e = 0], n)
            }, i.modulo = i.mod = function(n, e) {
                var i, o;
                return r = 11, n = new H(n, e), !this.c || !n.s || n.c && !n.c[0] ? new H(NaN) : !n.c || this.c && !this.c[0] ? new H(this) : (9 == T ? (o = n.s, n.s = 1, i = t(this, n, 0, 3), n.s = o, i.s *= o) : i = t(this, n, 0, T), this.minus(i.times(n)))
            }, i.negated = i.neg = function() {
                var n = new H(this);
                return n.s = -n.s || null, n
            }, i.plus = i.add = function(n, t) {
                var e, i = this.s;
                if (r = 12, t = (n = new H(n, t)).s, !i || !t) return new H(NaN);
                ...
                if (o = y(o), s = y(s), u = u.slice(), i = o - s) {
                    for (i > 0 ? (s = o, e = a) : (i = -i, e = u), e.reverse(); i--; e.push(0));
                    e.reverse()
                }
                for ((i = u.length) - (t = a.length) < 0 && (e = a, a = u, u = e, t = i), i = 0; t;) i = (u[--t] = u[t] + a[t] + i) / d | 0, u[t] = d === u[t] ? 0 : u[t] % d;
                ...
                var n, e, r, i, o, s = this.c,
                    u = this.s,
                    a = this.e,
                    c = S + 4,
                    l = new H("0.5");
                if (1 !== u || !s || !s[0]) return new H(!u || u < 0 && (!s || s[0]) ? NaN : s ? this : 1 / 0);
                if (0 == (u = Math.sqrt(+this)) || u == 1 / 0 ? (((e = x(s)).length + a) % 2 == 0 && (e += "0"), u = Math.sqrt(e), a = y((a + 1) / 2) - (a < 0 || a % 2), r = new H(e = u == 1 / 0 ? "1e" + a : (e = u.toExponential()).slice(0, e.indexOf("e") + 1) + a)) : r = new H(u + ""), r.c[0])
                    for ((u = (a = r.e) + c) < 3 && (u = 0);;)
                        if (o = r, r = l.times(o.plus(t(this, o, c, 1))), x(o.c).slice(0, u) === (e = x(r.c)).slice(0, u)) {
                            if (r.e < a && --u, "9999" != (e = e.slice(u - 3, u + 1)) && (i || "4999" != e)) {
                                +e && (+e.slice(1) || "5" != e.charAt(0)) || (W(r, r.e + S + 2, 1), n = !r.times(r).eq(this));
                                break
                            }
                ...
                var e, i, o, s, u, a, c, l, f, h, g, w, b, v, x, E = this.c,
                    N = (r = 17, n = new H(n, t)).c;
                if (!(E && N && E[0] && N[0])) return !this.s || !n.s || E && !E[0] && !N || N && !N[0] && !E ? n.c = n.e = n.s = null : (n.s *= this.s, E && N ? (n.c = [0], n.e = 0) : n.c = n.e = null), n;
                for (i = y(this.e / p) + y(n.e / p), n.s *= this.s, (c = E.length) < (h = N.length) && (b = E, E = N, N = b, o = c, c = h, h = o), o = c + h, b = []; o--; b.push(0));
                for (v = d, x = m, o = h; --o >= 0;) {
                    for (e = 0, g = N[o] % x, w = N[o] / x | 0, s = o + (u = c); s > o;) e = ((l = g * (l = E[--u] % x) + (a = w * l + (f = E[u] / x | 0) * g) % x * x + b[s] + e) / v | 0) + (a / x | 0) + w * f, b[s--] = l % v;
                    b[s] = e
                }
                return e ? ++i : b.splice(0, 1), V(n, b, i)
            }, i.toDigits = function(n, t) {
                var e = new H(this);
                return n = null != n && P(n, 1, b, 18, "precision") ? 0 | n : null, t = null != t && P(t, 0, 8, 18, l) ? 0 | t : L, n ? W(e, n, t) : e
                ...
                if (this.c) {
                    ...
                    if (s && (r = o, o = s, s = r, h -= r), o > 0 && h > 0) {
                        for (r = h % o || o, a = f.substr(0, r); r < h; r += o) a += u + f.substr(r, o);
                ...
                var e, r, i, s, u, a, c, l, f, h = I,
                    d = this.c,
                    g = new H(o),
                    m = r = new H(o),
                    b = c = new H(o);
                if (null != n && (I = !1, a = new H(n), I = h, (h = a.isInt()) && !a.lt(o) || (I && J(22, "max denominator " + (h ? "out of range" : "not an integer"), n), n = !h && a.c && W(a, a.e + 1, 1).gte(o) ? a : null)), !d) return this.toString();
                for (f = x(d), s = g.e = f.length - this.e - 1, g.c[0] = w[(u = s % p) < 0 ? p + u : u], n = !n || a.cmp(g) > 0 ? s > 0 ? g : m : a, u = k, k = 1 / 0, a = new H(f), c.c[0] = 0; l = t(a, g, 0, 1), 1 != (i = r.plus(l.times(b))).cmp(n);) r = b, b = i, m = c.plus(l.times(i = m)), c = i, g = a.minus(l.times(i = g)), a = i;
                return i = t(n.minus(r), b, 0, 1), c = c.plus(i.times(m)), r = r.plus(i.times(b)), c.s = m.s = this.s, e = t(m, b, s *= 2, L).minus(this).abs().cmp(t(c, r, s, L).minus(this).abs()) < 1 ? [m.toString(), b.toString()] : [c.toString(), r.toString()], k = u, e
            }, i.toNumber = function() {
                return +this
            }, i.toPower = i.pow = function(n, t) {
                var e, i, s, c = a(n < 0 ? -n : +n),
                    l = this;
                if (null != t && (r = 23, t = new H(t)), !P(n, -g, g, 23, "exponent") && (!isFinite(n) || c > g && (n /= 0) || parseFloat(n) != n && !(n = NaN)) || 0 == n) return e = Math.pow(+l, n), new H(t ? e % t : e);
                for (t ? n > 1 && l.gt(o) && l.isInt() && t.gt(o) && t.isInt() ? l = l.mod(t) : (s = t, t = null) : F && (e = u(F / p + 2)), i = new H(o);;) {
                    if (c % 2) {
                ...
                var t, e = this.s,
                    r = this.e;
                return null === r ? e ? (t = "Infinity", e < 0 && (t = "-" + t)) : t = "NaN" : (t = x(this.c), t = null != n && P(n, 2, 64, 25, "base") ? U(R(t, r), 0 | n, 10, e) : r <= j || r >= A ? B(t, r) : R(t, r), e < 0 && this.c[0] && (t = "-" + t)), t
            }, i.truncated = i.trunc = function() {
                return W(new H(this), this.e + 1, 1)
            }, i.valueOf = i.toJSON = function() {
                var n, t = this.e;
                return null === t ? this.toString() : (n = x(this.c), n = t <= j || t >= A ? B(n, t) : R(n, t), this.s < 0 ? "-" + n : n)
        ...
        function x(n) {
            for (var t, e, r = 1, i = n.length, o = n[0] + ""; r < i;) {
                for (t = n[r++] + "", e = p - t.length; e--; t = "0" + t);
                o += t
            }
        ...
        function E(n, t) {
            var e, r, i = n.c,
                ...
                c = t.e;
            if (!s || !u) return null;
            if (e = i && !i[0], r = o && !o[0], e || r) return e ? r ? 0 : -u : s;
            if (s != u) return s;
            if (e = s < 0, r = a == c, !i || !o) return r ? 0 : !i ^ e ? 1 : -1;
            if (!r) return a > c ^ e ? 1 : -1;
            for (u = (a = i.length) < (c = o.length) ? a : c, s = 0; s < u; s++)
                if (i[s] != o[s]) return i[s] > o[s] ^ e ? 1 : -1;
        ...
        function D(n, t, e) {
            for (var r, i, o = [0], s = 0, u = n.length; s < u;) {
                for (i = o.length; i--; o[i] *= t);
                for (o[r = 0] += h.indexOf(n.charAt(s++)); r < o.length; r++) o[r] > e - 1 && (null == o[r + 1] && (o[r + 1] = 0), o[r + 1] += o[r] / e | 0, o[r] %= e)
            }
            return o.reverse()
        }
